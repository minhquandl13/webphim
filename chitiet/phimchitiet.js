...
const items = document.querySelectorAll(
  ".container,.movie-list-title,.navbar-container,.sidebar,.left-menu-icon,.profile-text-container,.toggle,.menu-list-container,.menu-list"
);
